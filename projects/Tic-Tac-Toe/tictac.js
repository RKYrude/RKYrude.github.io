...
function startGameClick(){
    let audio = new Audio('../../Assets/TIC-TAC/sounds/clear-mouse-clicks.wav');
...
function boxClick(i){
    ...
    if(document.querySelectorAll(".box")[i].style.marginTop !== '9px'){ //if btn is NOT pressed. 9px means pressed
        ...
        if(playerTurn == 1){ //checks player turn     GREEN - RED
            ...
            document.querySelector("h1 img").setAttribute("src", "../../Assets/TIC-TAC/RED_INSET_CROSS.svg");
            document.querySelector("h1 span").style.cssText = "color: #FF625C;"; //RED
            document.querySelectorAll(".box")[i].setAttribute("src", "../../Assets/TIC-TAC/GREEN_CIRCLE.svg");
            ...
            playerTurn--;
            document.querySelectorAll("span")[0].innerText = playerTurn;
            document.querySelector("h1 img").setAttribute("src", "../../Assets/TIC-TAC/GREEN_INSET_CIRCLE.svg");
            document.querySelector("h1 span").style.cssText = "color: #12CDC0;"; //GREEN
            document.querySelectorAll(".box")[i].setAttribute("src", "../../Assets/TIC-TAC/RED_CROSS.svg");
...
function gameRestart(){
    let audio = new Audio('../../Assets/TIC-TAC/sounds/restart-sound2.wav');
    audio.volume = 0.5;
    audio.play();

    playerTurn = 1;
    document.querySelector(".game h1").innerHTML = 'Player <span>1</span> Turn <img draggable="false" src="../../Assets/TIC-TAC/WIN_CROWN.svg" alt="">';
    document.querySelectorAll("span")[0].innerText = playerTurn;
    document.querySelector("h1 img").setAttribute("src", "../../Assets/TIC-TAC/GREEN_INSET_CIRCLE.svg");
    document.querySelector("h1 span").style.cssText = "color: #12CDC0;"; //GREEN
    
    for(let i=0; i<9; i++){
        document.querySelectorAll(".box")[i].setAttribute("src", "../../Assets/TIC-TAC/GREY_GRID_BLOCK.svg"); //GREY BLOCK
...
function winTest() {
    ...
    if (winningCondition !== '') {
        let audio = new Audio('../../Assets/TIC-TAC/sounds/winning-sound.wav');
        audio.volume = 0.5;
        audio.play();

        

        document.querySelector(".game h1").innerHTML = `Player <span>${winner}</span> WON <img draggable="false" src="../../Assets/TIC-TAC/WIN_CROWN.svg" alt="">`;
        ...
        if (winner === '1') {
            ...
            for (let j = 0; j < 9; j++) {
                ...
                if (grid_match[j] === "X"){
                    box.setAttribute("src", "../../Assets/TIC-TAC/GREY_CROSS.svg");
                } 
                else if (grid_match[j] === "O"){
                    box.setAttribute("src", "../../Assets/TIC-TAC/GREY_CIRCLE.svg");
                }
            }
            ...
            if(winningCondition === 'top row'){
                for(let k=0; k<=2; k++){
                    ...
                    box.src = "../../Assets/TIC-TAC/GREEN_CIRCLE.svg";
        ...
        //Plaayer 2 condition
            ...
            if(winningCondition === 'top row'){
                for(let k=0; k<=2; k++){
                    box = document.querySelectorAll(".box")[k];
                    box.src = "../../Assets/TIC-TAC/RED_CROSS.svg";
        ...
        let audio = new Audio('../../Assets/TIC-TAC/sounds/draw-sound.wav');
        audio.volume = 0.5;
        audio.play();
       
        document.querySelector(".game h1").innerHTML = ' <span>DRAW</span> <img  draggable="false" src="../../Assets/TIC-TAC/DRAW.svg" alt="">';
